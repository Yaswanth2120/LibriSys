...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (email.endsWith("@student")) {
      ...
      } else if (email.endsWith("@librarian")) {
        userRole = "librarian";
        ...
        setError("Invalid email domain. Use @student, @librarian, or @admin.");
        return;
      }

      localStorage.setItem("userRole", userRole); // ✅ Save role for future use
    } catch (error) {
      setError(error.response?.data?.error || "Login failed"); // ✅ Handle error
    }
  };
